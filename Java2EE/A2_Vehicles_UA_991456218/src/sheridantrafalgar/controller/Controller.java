...
public class Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		pojo.setMake(req.getParameter("make"));
		pojo.setModel(req.getParameter("model"));
		pojo.setEnginetype(req.getParameter("enginetype"));
		pojo.setaiassistant(req.getParameter("aiassistant"));
		...
		pojo.setGallonthousandmilesgas(gtmgint);
...
//		String studentId = request.getParameter("ID");
		...
		if(carId == null || carId.isEmpty())
			...
			pojo.setCarid(Integer.parseInt(carId));

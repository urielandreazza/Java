...
public class Controller extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		pojo.setLaunchweight(req.getParameter("launchweight"));
		//valueOf or try-catch block
		gtmg = req.getParameter("heightmetres");
		int gtmgint;
		try{
		...
		pojo.setHeightmetres(gtmgint);
		
//		String studentId = request.getParameter("ID");
		String rocketID = req.getParameter("rocketID");
		
		if(rocketID == null || rocketID.isEmpty())
			dao.addRecord(pojo);
		else {
			pojo.setRocketid(Integer.parseInt(rocketID));
